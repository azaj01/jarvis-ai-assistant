...
TOOLSET := target
TARGET := fn_key_monitor
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=fn_key_monitor' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/src/native/fn_key_monitor.o
...
$(builddir)/fn_key_monitor.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/fn_key_monitor.node: LIBS := $(LIBS)
$(builddir)/fn_key_monitor.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/fn_key_monitor.node: TOOLSET := $(TOOLSET)
$(builddir)/fn_key_monitor.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/fn_key_monitor.node
# Add target alias
.PHONY: fn_key_monitor
fn_key_monitor: $(builddir)/fn_key_monitor.node

# Short alias for building this executable.
.PHONY: fn_key_monitor.node
fn_key_monitor.node: $(builddir)/fn_key_monitor.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/fn_key_monitor.node
