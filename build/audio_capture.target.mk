...
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=audio_capture' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/src/native/audio_capture.o
...
$(builddir)/audio_capture.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/audio_capture.node: LIBS := $(LIBS)
$(builddir)/audio_capture.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/audio_capture.node: TOOLSET := $(TOOLSET)
$(builddir)/audio_capture.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/audio_capture.node
# Add target alias
.PHONY: audio_capture
audio_capture: $(builddir)/audio_capture.node

# Short alias for building this executable.
.PHONY: audio_capture.node
audio_capture.node: $(builddir)/audio_capture.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/audio_capture.node
