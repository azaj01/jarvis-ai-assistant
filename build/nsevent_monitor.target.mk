...
TOOLSET := target
TARGET := nsevent_monitor
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=nsevent_monitor' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/src/native/nsevent_monitor.o
...
$(builddir)/nsevent_monitor.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/nsevent_monitor.node: LIBS := $(LIBS)
$(builddir)/nsevent_monitor.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/nsevent_monitor.node: TOOLSET := $(TOOLSET)
$(builddir)/nsevent_monitor.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/nsevent_monitor.node
# Add target alias
.PHONY: nsevent_monitor
nsevent_monitor: $(builddir)/nsevent_monitor.node

# Short alias for building this executable.
.PHONY: nsevent_monitor.node
nsevent_monitor.node: $(builddir)/nsevent_monitor.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/nsevent_monitor.node
