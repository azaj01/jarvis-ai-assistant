...
$(builddir)/typing_monitor.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/typing_monitor.node: LIBS := $(LIBS)
$(builddir)/typing_monitor.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/typing_monitor.node: TOOLSET := $(TOOLSET)
$(builddir)/typing_monitor.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/typing_monitor.node
# Add target alias
.PHONY: typing_monitor
typing_monitor: $(builddir)/typing_monitor.node

# Short alias for building this executable.
.PHONY: typing_monitor.node
typing_monitor.node: $(builddir)/typing_monitor.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/typing_monitor.node
