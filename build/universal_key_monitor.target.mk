...
TOOLSET := target
TARGET := universal_key_monitor
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=universal_key_monitor' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/src/native/universal_key_monitor.o
...
$(builddir)/universal_key_monitor.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/universal_key_monitor.node: LIBS := $(LIBS)
$(builddir)/universal_key_monitor.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/universal_key_monitor.node: TOOLSET := $(TOOLSET)
$(builddir)/universal_key_monitor.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/universal_key_monitor.node
# Add target alias
.PHONY: universal_key_monitor
universal_key_monitor: $(builddir)/universal_key_monitor.node

# Short alias for building this executable.
.PHONY: universal_key_monitor.node
universal_key_monitor.node: $(builddir)/universal_key_monitor.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/universal_key_monitor.node
